package com.grug.zookeeper.distributedLock;
...
public class SimpleDistributedLock extends BaseDistributedLock implements DistributedLock {
     ...
     * 这样创建后的节点类似：distributedLock-00000001，distributedLock-000000002
     */
    private static final String LOCK_NAME = "distributedLock-";
