...
public class PremiumCoffeeMachine implements CoffeeMachine {
     ...
     */
    @Override
    public void addCoffee(CoffeeSelection sel, Coffee newBeans) throws CoffeeException {
        if (!(newBeans instanceof CoffeeBean)) {
            throw new CoffeeException("Only coffee bean support.");
        }
        ...
        if (existingBeans != null) {
            ...
            this.beans.put(sel, (CoffeeBean) newBeans);
        }
    }
}
