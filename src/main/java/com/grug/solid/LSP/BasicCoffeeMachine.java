...
public class BasicCoffeeMachine implements CoffeeMachine {
    ...
    @Override
    public void addCoffee(CoffeeSelection sel, Coffee newCoffee) throws CoffeeException {
        if (!(newCoffee instanceof GroundCoffee)) {
            throw new CoffeeException("Only ground coffee support.");
        }
        ...
        if (existingCoffee != null) {
            ...
            this.groundCoffee.put(sel, (GroundCoffee) newCoffee);
        }
    }
}
